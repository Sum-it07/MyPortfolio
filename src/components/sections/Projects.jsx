  ...
  const projects = [
    {
      ...
      category: 'RAG / NLP',
      year: '2025',
      description: 'A RAG-based chatbot providing emotional support and mental wellbeing guidance. Uses retrieval-augmented generation to deliver empathetic, context-aware responses grounded in psychology resources.',
    ...
    },
    {
      ...
      year: '2025',
      description: 'An intelligent corporate handbook assistant powered by RAG. Employees can query company policies, HR guidelines, and procedures through natural conversation with instant, accurate answers.',
    ...
    },
    {
      ...
      category: 'NLP / AI',
      year: '2025',
      description: 'An AI-powered resume feedback system that analyzes resumes against job descriptions, scores key sections, and provides actionable suggestions to improve ATS compatibility and impact.',
      tech: ['Python', 'NLP', 'Streamlit', 'OpenAI'],
      color: '#30d158',
    },
    {
      id: 4,
      ...
      year: '2025',
      description: 'A deep learning-based deepfake detection system using CNNs and frame-level analysis to classify real vs. manipulated video content with high accuracy.',
